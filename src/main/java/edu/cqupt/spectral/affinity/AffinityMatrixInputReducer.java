...
import org.apache.mahout.clustering.spectral.Keys;
...
public class AffinityMatrixInputReducer
    extends Reducer<IntWritable,MatrixEntryWritable, IntWritable, VectorWritable> {
  @Override
  protected void reduce(IntWritable row, Iterable<MatrixEntryWritable> values, Context context)
    ...
    for (MatrixEntryWritable element : values) {
